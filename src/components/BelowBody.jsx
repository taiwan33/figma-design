...
const BelowBody = () => {
    return (
        <div className="bg-[#7854F7]">
            ...
            <div className='bg-[#7854F7] px-6 overflow-visible md:px-20 pb-4 md:pb-0 md:-mb-4 '>
                <div className='block md:flex lg:px-[4%]'>
                    <div className='relative flex-1 '>
                        <img className='flex-shrink-0 object-contain relative overflow-visible -top-8 z-50' src={Picture.bbody2} alt="" />
                        <div>
                            <div>
                    ...
                    <div className='text-white flex-1 lg:ml-10 place-self-center space-y-5 md:px-[2%]'>
                        <p className='text-3xl font-semibold'>Recipients</p>
                        <p className='text-md tracking-wider'>This course is aimed at those who want to write with the keyboard correctly optimizing time and those who spend hours writing on the keyboard for work and still have not acquired the skills necessary to write with the ten fingers without looking at the keyboard.</p>
                ...
                <div className='text-white flex-col-reverse flex md:flex-row mt-5 md:mt-0'>
                    ...
                    <div className=' space-y-5 flex-1 place-self-center px-[2%]'>
                        <p className='text-3xl font-semibold'>Programs</p>
                        <p className='text-md tracking-wider'>The proposed program consists of a first theoretical part and, to follow, a series of exercises designed by the training institution "Unitalent", you will gradually get to write texts through the use of 10 fingers.</p>
                        <button className='bg-[#239CAC] btn text:2xl md:text-lg'>Read the  Documentation</button>
                    </div>
                ...
                <div className='block md:flex py-[2%] px-[4%] mt-5 md:mt-0'>
                    <div className='relative flex-1 pl-8'>
                        <img className='flex-shrink-0 object-contain md:h-[400px] w-auto relative z-10' src={Picture.bbody3} alt="" />
                        <div className=''>
                            <div>
                                <img className='flex-shrink-0 object-contain h-10 w-auto absolute top-[16%] -left-[8%] z-20' src={Picture.ring2} alt="" />
                            </div>
                            <div className=''>
                                <img className='flex-shrink-0 object-contain h-[200px] md:h-[272px] absolute -bottom-12 -left-[7%] w-auto' src={Picture.ring} alt="" />
                            </div>
                            <img src={Picture.dot} className="flex-shrink-0 object-contain h-72 absolute -left-10 -bottom-44" alt="" />
                        </div>
                    </div>
                    <div className='text-white flex-1 place-self-center space-y-5 mt-10 md:mt-0 ml-4'>
                        <p className='text-3xl font-semibold'>Certification</p>
                        <p className='text-md tracking-wider'>At the end of the course there will be a final exam to certify the skills acquired. Upon passing the exam, a Certificate of Professional Training for Typing will be issued.</p>
                        <button className='bg-[#239CAC] btn text:2xl md:text-lg'>Read the  Documentation</button>
                    </div>
                    <div className='w-[6%]'></div>
                </div>
                ...
                <div className='block md:flex px-[4%] my-8'>
                    ...
                    <div className='text-white flex-1 place-self-center space-y-5 md:ml-10 mt-10 md:mt-0'>
                        <p className='text-3xl font-semibold'>Recipients</p>
                        <p className='text-md tracking-wider'>Deliberation
