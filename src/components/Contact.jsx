...
const Contact = () => {
    return (
        <div className=' pt-16 bg-gradient-to-b from-[#ECF0DE] to bg-[#ECF0DE]'>
            ...
            <form className='flex justify-around place-items-center text-[#94A2B3] mt-3'>
                <div>
                    <img className='h-24 w-auto' src={Picture.form3} alt="" />
                </div>
                <div className='bg-white w-[63%] rounded-xl'>
                    <div className=' grid grid-cols-2 gap-4 p-6'>
                        <input className='form-input' placeholder='Name' />
                        <input className='form-input' placeholder='Surname' />
                        <input className='form-input' placeholder='Telephone' />
                        <input className='form-input' placeholder='Email' />
                        <textarea className='form-input w-[205%] h-28' placeholder='Write a message here to get apointment' />
                    </div>
                    <div className='flex ml-6 place-items-center gap-6'>
                        <input type='checkbox' id='consent' />
                        <label htmlFor='consent' className=''>I consent to the processing of my personal data.</label>
                    </div>
                    <div className='flex justify-center my-4'>
                        <button className='rounded-full bg-[#7F67AA] text-white text-xs px-16 py-2' >Send</button>
                    </div>
                </div>
                <div>
            ...
            <div className='flex justify-around py-3'>
                <img className='h-24 w-auto' src={Picture.form1} alt="" />
                <img className='h-24 w-auto' src={Picture.form6} alt="" />
            </div>
        </div>
    )
}
